...
const PreviewArticleDrawer = ({
  ...
  if (previewArticleContent) {
    headline = previewArticleContent.headline.print_headline || null
    media = previewArticleContent.multimedia.length > 0 
      ? `https://graphics8.nytimes.com/${previewArticleContent.multimedia.find((media) => media.subtype === 'jumbo').url}` 
      : null
